...
// USE TO COMPILE
// g++ -std=c++17 -I../include/chess -I../include -I../include/utils -o perft_multi.out perft_multithreaded.cpp ../src/chess/*.cpp ../src/chess/movegen/*.cpp ../src/utils/threadpool.cpp ../src/engine/*.cpp ../src/engine/search/*.cpp -O3 -march=native -flto -funroll-loops
