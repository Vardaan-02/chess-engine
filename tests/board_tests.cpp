// Compile using this :: g++ -I../include/chess -o board_tests.out board_tests.cpp ../src/chess/board.cpp ../src/chess/fen.cpp
...
int main() {
    ...
    for (size_t i = 0; i < fens.size(); i++) {
        board = FEN::parse_fen(fens[i]);
        std::string resultFEN = FEN::to_fen(board);
